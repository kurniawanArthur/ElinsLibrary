...
void returnBook() {
    ...
    cout << "berikut buku yang anda pinjam \n";
    cout << books[whatBook-1].judul << ", " <<books[whatBook-1].namaPenulis << ", " << books[whatBook-1].tahunTerbit << ", id:" << books[whatBook-1].uniqueId << "." << endl;;

    cout << "\n apakah anda ingin mengembalikannya?\n";
    char yesOrNo;
    cin >>yesOrNo;
    if (yesOrNo == 'y') {
        cout << "buku " << books[whatBook-1].judul << ", " <<books[whatBook-1].namaPenulis << ", " << books[whatBook-1].tahunTerbit << ", id:" << books[whatBook-1].uniqueId << ". "  << "Telah berhasil dikembalikan. Terimakasih";
    } else {
        back();
    } 
    whatBook = -1;
